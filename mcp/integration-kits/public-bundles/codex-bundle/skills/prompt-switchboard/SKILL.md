...
description: Use Prompt Switchboard as a compare-first local MCP workspace during Codex sessions.
---

# Prompt Switchboard

Use this skill when Codex should compare one prompt across multiple supported AI
chat tabs through the local Prompt Switchboard MCP surface.
...
- This bundle assumes Codex already knows how to launch the local Prompt Switchboard MCP server.
